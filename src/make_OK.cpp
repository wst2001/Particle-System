...
int main(int argc, char *argv[]) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		*
		...
		modifier["thumb_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(3.0), glm::fvec3(0.0, 0.0, 1.0));
		modifier["thumb_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(6.0), glm::fvec3(0.0, -1.0, 0.0));
		modifier["thumb_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(3.0), glm::fvec3(0.0, 0.0, 1.0));
		modifier["thumb_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(3.0), glm::fvec3(0.0, 0.0, 1.0));

		modifier["index_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(3.0), glm::fvec3(0.0, 0.0, 1.0));
		modifier["index_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(3.0), glm::fvec3(0.0, 0.0, 1.0));
		modifier["index_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(3.0), glm::fvec3(0.0, 0.0, 1.0));
