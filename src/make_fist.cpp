...
int main(int argc, char *argv[]) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		*
		...
		modifier["thumb_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(2.0), glm::fvec3(0.0, 0.0, 1.0));
		modifier["thumb_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(3.0), glm::fvec3(0.0, 1.0, 0.0));
		modifier["thumb_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(2.5), glm::fvec3(0.0, 0.0, 1.0));
		modifier["thumb_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(2.5), glm::fvec3(0.0, 0.0, 1.0));

		float index_angle = get_angle(2.5f);
		modifier["index_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), index_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["index_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), index_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["index_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), index_angle, glm::fvec3(0.0, 0.0, 1.0));

		float middle_angle = get_angle(2.5f);
		modifier["middle_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), middle_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["middle_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), middle_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["middle_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), middle_angle, glm::fvec3(0.0, 0.0, 1.0));

		float ring_angle = get_angle(2.5f);
		modifier["ring_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), ring_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["ring_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), ring_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["ring_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), ring_angle, glm::fvec3(0.0, 0.0, 1.0));

		float pinky_angle = get_angle(2.5f);
		modifier["pinky_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), pinky_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["pinky_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), pinky_angle, glm::fvec3(0.0, 0.0, 1.0));
		modifier["pinky_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), pinky_angle, glm::fvec3(0.0, 0.0, 1.0));
