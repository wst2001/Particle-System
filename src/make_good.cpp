...
int main(int argc, char *argv[]) {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		*
		...
		modifier["thumb_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(4.0), glm::fvec3(0.0, 1.0, 0.0));
		modifier["thumb_proximal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(-5.0), glm::fvec3(0.0, 0.0, 1.0));
		modifier["thumb_intermediate_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(-5.0), glm::fvec3(0.0, 0.0, 1.0));
		modifier["thumb_distal_phalange"] = glm::rotate(glm::identity<glm::mat4>(), get_angle(-5.0), glm::fvec3(0.0, 0.0, 1.0));

		float index_angle = get_angle(2.0f);
		...
		float middle_angle = get_angle(2.0f);
		...
		float ring_angle = get_angle(2.0f);
		...
		float pinky_angle = get_angle(2.0f);
